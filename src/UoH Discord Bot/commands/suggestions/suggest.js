...
module.exports = {
    ...
    run: async ({ interaction }) => {
        try {
            const guildConfiguration = await SuggestionGuildConfiguration.findOne({ guildId: interaction.guildId });
            ...
            const suggestionEmbed = new EmbedBuilder()
                ...
                .addFields([
                    ...
                    { name: 'Satus', value: '⏳ Pending'},
                    { name: 'Votes', value: formatSuggestions() }
